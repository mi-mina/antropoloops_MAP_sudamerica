...
//============================================================================
void setup() {
size(displayWidth, displayHeight); // To adapt to screen
    // size(1280, 720); // Fixed screen size
  
  if (frame != null) {
    frame.setResizable(true);
  }

 // mundi = loadImage("../1_BDatos/sudamerica_old/"+"mapa_1728x1080_sudamerica_historic.png");
  mundi = loadImage("../1_BDatos/"+"mapa_1728x1080_sudamerica_old.png");
  ...
  */
  ...
  misLugaresJSON = loadJSONArray ("../1_BDatos/"+"BDlugares_sudamerica.txt");
